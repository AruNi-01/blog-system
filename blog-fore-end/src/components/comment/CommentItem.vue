    ...
    <div class="me-view-comment-author">
      ...
      <div class="me-view-info">
        ...
        <div class="me-view-meta">
          <span>{{rootCommentCounts - index}}楼</span>&emsp;&emsp;
      ...
      <div class="me-reply-list">
        <div class="me-reply-item" v-for="c in comment.children" :key="c.id">
          <div style="font-size: 14px">
            ...
            <span class="repeat-font">回复&nbsp;</span>@{{c.toUser.nickname}}： </span>
        ...
        <div class="me-view-comment-write" v-show="commentShow">
          ...
          <el-button  style="repeat-send-button"  @click="publishComment()">发送</el-button>
